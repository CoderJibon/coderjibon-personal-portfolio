...
function Counter() {
  return (
    <>
      <div className="hidden sm:flex justify-between gap-3 items-center mt-4">
      ...
      {/* marquee slide */}
      <div className="flex sm:hidden justify-between gap-3 items-center mt-4">
        <Marquee>
          <div className="flex items-center gap-4 mr-3 bg-success dark:bg-gray-100 w-fit px-4 rounded-md py-2">
            <h3 className="font-bold dark:text-primary text-5xl sm:text-6xl ">
              <CountUp start={0} end={3} />+
            </h3>
            <p className="text-lg dark:text-success text-gray-400 ">
              Years of Experience
